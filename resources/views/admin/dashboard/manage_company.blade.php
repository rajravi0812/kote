        ...
        <div class="page-wrapper">
                                    ...
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td id="cat_{{ $request->id }}"><center>{{ $request->company_name }}</center></td>
                                                <td><center>
                ...
                <div class="modal-dialog">
                    ...
                    <form action="{{ route('add.company') }}" method="POST">
                        ...
                        <div class="modal-header">
                            <h4 class="modal-title"><strong>Add</strong> company</h4>
                        ...
                        <div class="modal-body">
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        <input class="form-control form-white" placeholder="Enter company" type="text" name="item_category_name" />
                                    </div>
                                    {{-- <div class="col-md-4">
            ...
            <div class="modal fade none-border" id="add-edit-event">
                <div class="modal-dialog">
                    ...
                    <form action="{{ route('update.company') }}" method="POST">
                        @csrf
                        <div class="modal-header">
                            <h4 class="modal-title"><strong>Edit</strong> company</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        </div>
                        <div class="modal-body">
            ...
            <div class="modal fade none-border" id="delete-event">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title"><strong>Delete</strong> Company</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        </div>
                        <div class="modal-body">
