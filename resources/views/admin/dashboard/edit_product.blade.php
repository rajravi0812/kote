        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">    
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <form action="{{ route('edit.product.action') }}" method="POST" id="assignVehForm"  enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-md-7">
                                                                        <input value="{{$products->product_name}}" type="text" class="form-control" id="productName" placeholder="Enter Product Name" name="product_name" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                    ...
                                                                    <div class="col-md-7">
                                                                        <select class="select2 form-control custom-select" style="width: 100%; height:36px;" name="category" required>
                                                                            ...
                                                                            @foreach ($productCat as $cat)
                                                                                <option value="{{ $cat->id }}"  {{$products->product_cat_id == $cat->id ? 'selected' : ''}}>{{ $cat->p_cat_name }}</option>
                                                                            @endforeach
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-md-7">
                                                                        <select class="select2 form-control custom-select" style="width: 100%; height:36px;" name="fund_category" required>
                                                                            <option value="">Select</option>
                                                                            @foreach ($fundCat as $cat)
                                                                                <option value="{{ $cat->id }}" 
                                                                                    {{ $products->fund_sub_cat_id === $cat->id ? 'selected' : '' }}>
                                                                                    {{ $cat->fund_cat_name }}
                                                                                </option>
                                                                            @endforeach
                                                                        </select>
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-md-7">
                                                                        <select class="select2 form-control custom-select" style="width: 100%; height:36px;" name="fund_sub_category" required>
                                                                            <option value="">Select</option>
                                                                            @foreach ($fundSubCat as $cat)
                                                                                <option value="{{ $cat->id }}" {{$products->fund_sub_id == $cat->id ? 'selected' : ''}}>{{ $cat->fund_subcat_name }}</option>
                                                                            @endforeach
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-md-7">
                                                                        <input type="text" value="{{$products->product_qty}}" class="form-control" id="qty" placeholder="Enter Product Qty" name="qty" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-12">
                                                                <div class="form-group row">
                                                                    <label class="col-sm-4 text-right control-label col-form-label">
                                                                        Does the product have a serial number (Yes/No):
                                                                    </label>
                                                                    <div class="col-md-8 d-flex align-items-center">
                                                                        <div class="form-check form-check-inline">
                                                                            <input class="form-check-input" type="radio" name="hasSerial" id="serialYes" value="no" {{$products->having_serial == 'no' ? 'checked' : ''}}>
                                                                            <label class="form-check-label" for="serialYes">No</label>
                                                                        </div>
                                                                        <div class="form-check form-check-inline">
                                                                            <input class="form-check-input" type="radio" name="hasSerial" id="serialNo" value="yes" {{$products->having_serial == 'yes' ? 'checked' : ''}}>
                                                                        ...
                                                                        <div class="ml-3 d-none" id="serialNumberField">
                                                                            <input type="text" class="form-control" id="serialNoInput" value="{{$products->serial_no ?? ''}}" name="serialNo" placeholder="Enter Serial No">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-md-7">
                                                                        <input type="text" class="form-control" id="crvNo" name="crv_no" value="{{$products->crv_no}}" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-md-7">
                                                                        <input type="date" class="form-control" id="crvDate" value="{{$products->crv_date}}" name="crv_date" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-md-7">
                                                                        <input type="text" class="form-control" id="ledgerNo" value="{{$products->ledger_no}}" name="ledger_no" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-md-7">
                                                                        <input type="text" class="form-control" id="ledgerPageNo" name="ledger_page_no" value="{{$products->ledger_page_no}}" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-md-7">
                                                                        <input type="text" class="form-control" id="issueVoucherNo" name="issue_voucher_no" value="{{$products->issue_voucher_no}}"  required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-md-7">
                                                                        <input type="date" class="form-control" id="issueVoucherDate" name="issue_voucher_date" value="{{$products->issue_voucher_date}}"  required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-md-7">
                                                                        <input type="text" class="form-control" id="billNo" name="bill_no" value="{{$products->bill_no}}" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-md-7">
                                                                        <input type="date" class="form-control" id="billDate" name="bill_date" value="{{$products->bill_date}}"  required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-md-7">
                                                                        <input type="number" class="form-control" id="warrantyYears" value="{{$products->warranty_yr}}" name="warranty_years" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-md-7">
                                                                        <input type="date" class="form-control" id="warrantyExpiry" value="{{$products->warranty_exp_date}}" name="warranty_expiry_date" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-md-7">
                                                                        <input type="date" class="form-control" id="amcDueDate" value="{{$products->amc_due_date}}" name="amc_due_date" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-md-7">
                                                                        <input type="number" class="form-control" id="price" value="{{$products->price}}" name="price" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-md-7">
                                                                        <input type="number" class="form-control" id="annualDepreciation" name="annual_dep" value="{{$products->annual_dep}}" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-md-7">
                                                                        <input type="number" class="form-control" id="current_price" name="current_price" value="{{$products->current_price}}" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-md-7">
                                                                        <input type="text" class="form-control" id="barcode" name="barcode" value="{{$products->scan_barcode}}" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-md-7">
                                                                        <input type="text" class="form-control" id="remarks" name="remarks" value="{{$products->remarks}}" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
     ...
     $(document).ready(function () {
        ...
        $('input[name="hasSerial"]').on('change', function () {
            if ($('#serialNo').is(':checked')) {
                // Show the serial number field if "Yes" is selected
                $('#serialNumberField').removeClass('d-none');
            } else {
                // Hide the serial number field if "No" is selected
        ...
        // Initial check to show or hide the serial number field based on the default selection
        if ($('#serialNo').is(':checked')) {
            $('#serialNumberField').removeClass('d-none');
        }
    });
