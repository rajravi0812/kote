                        ...
                        <form method="GET" action="{{ route('indl.list') }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <a href="{{ route('indl.list') }}" class="btn btn-secondary btn-sm">Reset</a>
                                    {{-- <a href="{{ route('indl.export', request()->all()) }}" class="btn btn-cyan">Export</a> --}}
                                            ...
                                            <tr>
                                                ...
                                                <td><center>
                                                        <a href="fingerprintapp://enroll?emp_id={{ urlencode($product->emp_id) }}&name={{ urlencode($product->name) }}" 
                                                            class="btn btn-{{ $product->status == 1 ? "success" : "danger"}} btn-sm " id="myButton">
