        ...
        <div class="page-wrapper">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            @if(!empty($branches))
                                            @foreach($branches as $request)
                                            <tr>
                                                <td><center>{{ ($branches->currentPage() - 1) * $branches->perPage() + $loop->iteration }}</center></td>
                                                <td id="cat_{{ $request->id }}"><center>{{ $request->branch_name }}</center></td>
                                                <td><center>
            ...
            <div class="modal fade none-border" id="add-new-event">
                <div class="modal-dialog">
                    ...
                    <form action="{{ route('add.branches') }}" method="POST">
                        @csrf
                        <div class="modal-header">
                            <h4 class="modal-title"><strong>Add</strong> Branches</h4>
                        ...
                        <div class="modal-body">
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        <input class="form-control form-white" placeholder="Enter name" type="text" name="dest_name" />
                                    </div>
            ...
            <div class="modal fade none-border" id="add-edit-event">
                <div class="modal-dialog">
                    <div class="modal-content">
                    <form action="{{ route('update.branches') }}" method="POST">
                        @csrf
                        <div class="modal-header">
                            <h4 class="modal-title"><strong>Edit</strong> branch</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        </div>
                        <div class="modal-body">
            ...
            <div class="modal fade none-border" id="delete-event">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title"><strong>Delete</strong> branch</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        </div>
                        <div class="modal-body">
                        ...
                        <div class="modal-footer">
                            <form action="{{ route('delete.branches') }}" method="POST">
                                @csrf
