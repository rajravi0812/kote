                                ...
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><center>{{ ($store->currentPage() - 1) * $store->perPage() + $loop->iteration }}</center></td>
                                                <td id="cat_{{ $request->id }}"><center>{{ $request->store_name }}</center></td>
                                                <td><center>
                ...
                <div class="modal-dialog">
                    ...
                    <form action="{{ route('add.store') }}" method="POST">
                        ...
                        <div class="modal-header">
                            <h4 class="modal-title"><strong>Add</strong> Store</h4>
                        ...
                        <div class="modal-body">
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        <input class="form-control form-white" placeholder="Enter name" type="text" name="item_store_name" />
                                    </div>
