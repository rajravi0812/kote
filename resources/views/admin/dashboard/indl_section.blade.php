            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2">
                        ...
                        {{-- <div class="card card-hover"> --}}
                            <div class="box  text-center">
                                <h1 class="font-light text-white"><img src="{{url("assets/img/add_indl.png")}}" width="90px"  alt="Main"></h1>
                    ...
                    <div class="col-lg-2">
                        ...
                        {{-- <div class="card card-hover"> --}}
                            <div class="box  text-center">
                                <h1 class="font-light text-white"><img src="{{url("assets/img/indl_list.png")}}" width="90px"  alt="Main"></h1>
                    ...
                    <div class="col-lg-2">
                        ...
                        {{-- <div class="card card-hover"> --}}
                            <div class="box  text-center">
                                <h1 class="font-light text-white"><img src="{{url("assets/img/allot_wpn.png")}}" width="90px"  alt="Main"></h1>
