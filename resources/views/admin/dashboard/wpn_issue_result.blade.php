            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Wpn Issued</h4>
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Wpn Issued</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <div class="card p-3">
                        <div class="text-center mb-4">
                            <a href="fingerprintapp://verify-in"  class="btn btn-warning btn-md" style="border-radius: 5px; width: 100%; font-weight:700;" >
                        ...
                        <div id="details" class="mb-4">
                            <div class="row align-items-center mb-3">
                                ...
                                <div class="col-md-8 text-center" id="image">
                                    <img src="{{ !empty($employee->photo) ?  url('/public' . $employee->photo) : "img/no_profile.png"}}" alt="Army Image" class="img-fluid rounded-square rounded" style="max-width: 150px; height: auto;">
                                </div>
                            </div>
                            ...
                            <div class="row align-items-center mb-3">
                                ...
                                <div class="col-md-8">
                                    <label class="form-label" id="army_no">{{$employee->emp_id}}</label>
                            ...
                            <div class="row align-items-center mb-3">
                                ...
                                <div class="col-md-8">
                                    <label class="form-label" id="rank">{{$employee->rank->rank_name}}</label>
                                </div>
                            </div>
                            <div class="row align-items-center mb-3">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-8">
                                    <label class="form-label" id="name">{{$employee->name}}</label>
                                </div>
                            </div>
                            <div class="row align-items-center mb-3">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-8">
                                    <label class="form-label" id="unit">{{$employee->unit->unit_name}}</label>
                                </div>
                            </div>
                            <div class="row align-items-center mb-3">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-8">
                                    <label class="form-label" id="company">{{ $employee->company->company_name}}</label>
                                </div> 
                            </div>
                        </div>
                    </div>
                  ...
                  <div class="col-md-8">
                        ...
                        <div class="row row-xs align-items-center">
                            ...
                            <div style="display: flex; align-items: center;" class="col-md-10 mg-t-5 mg-md-t-0">
                                <div style="display: flex; align-items: center;" class="custom-radio-group">
                                    <input id="maintainance" name="purpose" checked value="maintainance" required autocomplete="off" type="radio" style="margin-top: 0;">
                                    <label for="maintainance" class="form-label custom-radio" style="margin:0px 0 0 5px;">Maintenance</label>
                                </div>
                    ...
                    <div class="row row-xs align-items-center ">
                        ...
                        <div class="col-md-2">
                            <button type="button" class="btn btn-success btn-update" style="border-radius:4px" >Issue</button>
                        </div>
                        <div class="col-md-2">
                            <button class="btn btn-danger" style="border-radius:4px"> Cancel </button>
                        </div>
                    </div>
                  </div>
                </div>
...
<script>
    $(document).ready(function() {
        ...
        function handleFetch() {
            ...
            if (type == "maintainance" || type == "before_ins" || type == "on" || 
    ...
    if (event.which === 13) {
        ...
        $.ajax({
            ...
            success: function(response1) {
                ...
                console.log('Response1 selected:', response1);
                $('#tbody').empty();
                wpn_ids = [];
            ...
            complete: function() {
                ...
                $.ajax({
                    ...
                    success: function(response2) {
                        try {
                            console.log(response2,"not selected");
                        } catch (e) {
