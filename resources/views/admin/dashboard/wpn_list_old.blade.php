    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-body">
                        <form method="GET" action="{{ route('wpn.list') }}">
                            @csrf
                            <div class="row mb-3">
                                <div class="col-md-2">
                                ...
                                <div class="col-md-2 text-center">
                                    ...
                                    <a href="{{ route('wpn.list') }}" class="btn btn-secondary">Reset</a>
                                </div>
                            </div>
                        </form>
                    </div>
                                    ...
                                    <table id="zero_config" class="table table-striped table-bordered table-sm">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><center>
                                                    <a href="{{ route('edit.wpn',['id'=>$product->id])}}" class="btn btn-sm btn-warning" rel="{{$product->id}}">Edit</a>
