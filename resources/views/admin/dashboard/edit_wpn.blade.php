    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="form-container">
                <h2>Edit WPN</h2>
                <form action="{{ route('edit.wpn.action', $wpn->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-8">
                            <input type="text" id="wpn-tag" name="wpn_tag" class="form-control" value="{{ $wpn->wpn_tag }}">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-8">
                            <select id="weapon-type" class="form-select form-control" name="wpn_type">
                                <option value="">Select Weapon Type</option>
                                @foreach ($wpntype as $cat)
                                    <option value="{{ $cat->id }}" {{ $cat->id == $wpn->wpn_type ? 'selected' : '' }}>{{ $cat->type }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-8">
                            <input type="text" id="regd-no" name="regd_no" class="form-control" value="{{ $wpn->regd_no }}">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-8">
                            <input type="text" id="butt-no" name="butt_no" class="form-control" value="{{ $wpn->butt_no }}">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-8">
                            <select id="company" class="form-select form-control" name="company_id">
                                <option value="">Select Company</option>
                                @foreach ($company as $cat)
                                    <option value="{{ $cat->id }}" {{ $cat->id == $wpn->company_id ? 'selected' : '' }}>{{ $cat->company_name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-8">
                            <textarea id="remarks" class="form-control" name="remarks" rows="3">{{ $wpn->remarks }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-8">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="service" id="serviceable-yes" value="Yes" {{ $wpn->servicability == 'Yes' ? 'checked' : '' }}>
                                <label class="form-check-label" for="serviceable-yes">Yes</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="service" id="serviceable-no" value="No" {{ $wpn->servicability == 'No' ? 'checked' : '' }}>
